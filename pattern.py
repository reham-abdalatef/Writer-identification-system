...
for j in range (1,6):
    ...
    for i in range (0,len(images)):
        #cv2.imshow('dilated',images[i])
        #cv2.waitKey(0)
        countLines=SplitLines(images[i])
        for counter1 in range(0,countLines):
           ...
           # print(f5,f6,f7,f8,f9,f10)
            ...
            if i==0 or i==1:
                Linefeatures.append([f5,f6,f7,f8])
                label.append(str(1))
            elif i==2 or i==3:
                Linefeatures.append([f5,f6,f7,f8])
                label.append(str(2))
    ...
    for i in range (0,len(testimages)):
        #cv2.imshow('dilated',testimages[i])
        #cv2.waitKey(0)
        testfeatures=[]
        countLines=SplitLines(testimages[i])
        print("================test"+str(i+1)+"======================")
        onecount=0;
        twocount=0;
        threrecount=0;
        for counter1 in range(0,countLines):
            ...
            predicted= neigh.predict([[f5,f6,f7,f8]])
            testfeatures.append(predicted)
            if(predicted[0]=='1'):
                onecount=onecount + 1
            elif(predicted[0]=='2'):
                twocount=twocount + 1
            else:
                threrecount= threrecount + 1
        print("onecount")
        print(onecount)
        print("twocount")
        print(twocount)
